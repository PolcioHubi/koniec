...
class ProductionConfig:
    ...
    ADMIN_PASSWORD = os.environ.get('ADMIN_PASSWORD', 'change_this_password_in_production')
    ...
    RATELIMIT_STORAGE_URL = os.environ.get('RATELIMIT_STORAGE_URL', 'redis://redis:6379')

    # Admin credentials (KRYTYCZNE: ZMIEŃ W PRODUKCJI! Użyj zmiennych środowiskowych lub bezpiecznego menedżera sekretów!)
    ADMIN_USERNAME = os.environ.get('ADMIN_USERNAME', 'admin')
    ADMIN_PASSWORD = os.environ.get('ADMIN_PASSWORD', 'change_this_password_in_production')
    ...
    def init_app(app):
        ...
        if not app.debug and not app.testing:
            ...
            app.logger.info("Aplikacja Dowodnowy HTML uruchomiona w trybie produkcyjnym z logowaniem JSON.")
